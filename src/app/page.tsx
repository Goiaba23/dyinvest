  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/register" className="text-sm font-medium text-white bg-gray-900 px-5 py-2.5 rounded-full hover:bg-gray-800 transition-all">
              Começar grátis
            </Link>
          </div>
        </div>
      ...
      <section className="pt-40 pb-20 px-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link href="/register" className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-purple-600 text-white font-medium px-8 py-4 rounded-full hover:opacity-90 transition-all flex items-center justify-center gap-2">
      ...
      <section className="py-16 px-8 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-semibold text-gray-900 mb-2">Tudo que você precisa</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="bg-white rounded-2xl p-5 border border-gray-100 hover:border-gray-200 hover:shadow-md transition-all">
      ...
      <section className="py-16 px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-semibold text-gray-900 mb-2">Suas áreas de análise</h2>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={i} className="bg-white rounded-2xl p-5 border border-gray-100 hover:border-gray-200 hover:shadow-md transition-all cursor-pointer flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">{item.count} ativos</p>
                  </div>
                </div>
      ...
      {/* Stats */}
      <section className="py-12 px-8 bg-gray-900">
        <div className="max-w-4xl mx-auto">
      ...
      <section className="py-20 px-8">
        <div className="max-w-xl mx-auto text-center">
          ...
          <Link href="/register" className="inline-flex items-center justify-center gap-2 bg-gray-900 text-white font-medium px-8 py-4 rounded-full hover:bg-gray-800 transition-all">
            Criar conta grátis
            <ArrowRight className="w-5 h-5" />
          </Link>
        </div>
