...
function CustomCursor() {
  ...
  return (
    <motion.div
      className="fixed w-5 h-5 rounded-full border-2 border-[#0d9488] pointer-events-none z-[100] mix-blend-difference"
...
function MarqueeText({ items }: { items: string[] }) {
  return (
    <div className="flex overflow-hidden py-4 border-y border-white/[0.06]">
      <motion.div
      ...
      >
        {[...items, ...items].map((item, i) => (
          <span key={i} className="text-2xl font-medium text-neutral-600 mx-8">
            {item}
          </span>
        ))}
      </motion.div>
...
function TiltCard({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  ...
  return (
    <motion.div
      ...
      onMouseLeave={handleMouseLeave}
      style={{
        rotateX: useTransform(ySpring, [-100, 100], [12, -12]),
        rotateY: useTransform(xSpring, [-100, 100], [-12, 12]),
  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrolled 
          ? "bg-[#050505]/95 backdrop-blur-2xl border-b border-white/[0.08] py-3" 
          : "bg-transparent py-5"
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <MagneticButton className="flex items-center gap-3 group cursor-pointer">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#0d9488] to-[#0f766e] flex items-center justify-center shadow-lg shadow-[#0d9488]/20 group-hover:scale-110 transition-transform">
        ...
        <div className="hidden md:flex items-center gap-10">
          {navLinks.map((link, i) => (
            <MagneticButton key={link.label} className="cursor-pointer">
              <a
                href={link.href}
        ...
        <div className="flex items-center gap-4">
          <a href="#login" className="hidden md:block text-sm text-neutral-400 hover:text-white transition-colors">
            Entrar
          </a>
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32 pb-20">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(30)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute w-1 h-1 bg-[#0d9488]/40 rounded-full"
            initial={{ 
              x: Math.random() * 100 + "%", 
              y: Math.random() * 100 + "%",
            }}
      ...
      <motion.div style={{ opacity }} className="max-w-6xl mx-auto px-6 text-center relative z-10">
        ...
        >
          <WordReveal text="Investimento com" />
          <br />
...
function Features() {
  const features = [
    { icon: Brain, title: "Análise de IA", description: "Múltiplas IA analisam notícias globais e geram probabilidades de mercado em tempo real.", tag: "AI", color: "from-purple-500 to-pink-500" },
    { icon: TrendingUp, title: "Probabilidades Claras", description: "Entenda as chances de alta ou baixa de cada ativo sem precisar ser expert.", tag: "Novo", color: "from-green-500 to-emerald-500" },
    { icon: Globe, title: "Notícias Globais", description: "Tradução automática de notícias internacionais sobre empresas e mercados.", tag: "Pro", color: "from-blue-500 to-cyan-500" },
    { icon: Wallet, title: "Carteira Personalizada", description: "Acompanhe seus investimentos e receba alertas de probabilidade em tempo real.", tag: "AI", color: "from-orange-500 to-amber-500" },
    { icon: Shield, title: "Dados Seguros", description: "Suas informações protegidas com criptografia de nível bancário.", tag: "Seguro", color: "from-red-500 to-rose-500" },
    { icon: PieChart, title: "Análise Fundamentalista", description: "Indicadores financeiros, dividend yield e valuation simplificado para todos.", tag: "Pro", color: "from-indigo-500 to-violet-500" },
  ];
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-start justify-between mb-6">
                    <motion.div whileHover={{ scale: 1.1, rotate: 5 }} className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${feature.color} flex items-center justify-center shadow-lg`}>
...
function BentoFeatures() {
  const items = [
    ...
    { title: "Glossário Financeiro", description: "Tradução de siglas e termos técnicos", icon: Brain, color: "from-purple-400 to-pink-500" },
    { title: "50+ Ativos", description: "Ações, ETFs, FIIs, BDRs e cryptos", icon: BarChart3, color: "from-green-400 to-emerald-500" },
    { title: "Alertas Inteligentes", description: "Notificações quando probabilidades mudam", icon: Shield, color: "from-blue-400 to-cyan-500" },
    ...
    { title: "Simulador Rápido", description: "Teste cenários sem risco", icon: Wallet, color: "from-indigo-400 to-violet-500" },
  ];
...
function Stats() {
  const stats = [
    { value: "50+", label: "Ativos Monitorados", icon: BarChart3 },
    { value: "10K+", label: "Investidores", icon: Users },
  ...
  return (
    <section className="py-20 bg-[#050505] relative overflow-hidden">
      ...
      <MarqueeText items={stats.map(s => s.label)} />
            ...
            <RevealOnScroll key={i} delay={i * 0.1}>
              <div className="text-center group">
                <motion.div
                  ...
                  className="text-4xl md:text-5xl font-bold text-white mb-2 inline-flex items-center gap-3"
                >
...
function Pricing() {
  const plans = [
    { name: "Free", price: "R$ 0", period: "/mês", description: "Para quem está começando", features: ["Acesso a 10 ativos", "1 análise por dia", "Notícias básicas", "Glossário completo"], cta: "Começar Grátis", highlight: false },
    { name: "Pro", price: "R$ 49", period: "/mês", description: "Para investidores ativos", features: ["50+ ativos Unlimited", "Análises ILIMITADAS", "Notícias em tempo real", "Alertas de probabilidade", "Carteira completa", "Comparador de ativos"], cta: "Assinar Pro", highlight: true, badge: "Mais Popular" },
    { name: "Enterprise", price: "Sob Consulta", period: "", description: "Para instituições e advisors", features: ["Tudo do Pro", "Múltiplos portfólios", "API de dados", "Relatórios customizados", "Suporte prioritário", "White label"], cta: "Falar com Vendas", highlight: false },
  ];
          ...
          {plans.map((plan, i) => (
            <RevealOnScroll key={i} delay={i * 0.15}>
              ...
              >
                ...
                <MagneticButton className="cursor-pointer w-full">
                  <motion.a
                    href="#signup"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
