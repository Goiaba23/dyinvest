...
export default function FooterSection() {
  ...
  return (
    <footer className="py-20 bg-[#030303] border-t border-white/[0.05]">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-16">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-white font-medium text-[16px]">DYInvest</span>
            </div>
            <p className="text-white/35 text-[14px] leading-relaxed max-w-xs mb-6">
              A plataforma inteligente que transforma dados do mercado em decisões de investimento acionáveis.
            </p>
          ...
          {/* Links */}
          <div>
            <h4 className="text-white text-[14px] font-medium mb-4">Produto</h4>
            <ul className="space-y-3">
              {links.product.map((link, i) => (
                <li key={i}>
                  <a href={link.href} className="text-white/35 text-[14px] hover:text-white transition-colors">
                    {link.name}
                  </a>
                </li>
              ))}
          ...
          <div>
            <h4 className="text-white text-[14px] font-medium mb-4">Empresa</h4>
            <ul className="space-y-3">
          ...
          <div>
            <h4 className="text-white text-[14px] font-medium mb-4">Legal</h4>
            <ul className="space-y-3">
        ...
        <div className="pt-8 border-t border-white/[0.05] flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-white/20 text-[12px]">
            Feito com IA para investidores brasileiros
          </p>
        </div>
      </div>
    </footer>
